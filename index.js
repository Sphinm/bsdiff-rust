...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      ...
      try {
        const binding = require('@bsdiff-rust/node-win32-x64-gnu')
        const bindingPackageVersion = require('@bsdiff-rust/node-win32-x64-gnu/package.json').version
        if (bindingPackageVersion !== '0.0.4' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.0.4 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require('@bsdiff-rust/node-linux-loong64-musl')
          const bindingPackageVersion = require('@bsdiff-rust/node-linux-loong64-musl/package.json').version
          if (bindingPackageVersion !== '0.0.4' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 0.0.4 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
        ...
        try {
          const binding = require('@bsdiff-rust/node-linux-loong64-gnu')
          const bindingPackageVersion = require('@bsdiff-rust/node-linux-loong64-gnu/package.json').version
          if (bindingPackageVersion !== '0.0.4' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 0.0.4 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  if (!nativeBinding) {
    try {
      wasiBinding = require('@bsdiff-rust/node-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
...
module.exports.diffWithOptions = nativeBinding.diffWithOptions
module.exports.diffWithOptionsAndStats = nativeBinding.diffWithOptionsAndStats
module.exports.diffWithOptionsAndStatsSync = nativeBinding.diffWithOptionsAndStatsSync
module.exports.diffWithOptionsSync = nativeBinding.diffWithOptionsSync
module.exports.diffWithStats = nativeBinding.diffWithStats
module.exports.diffWithStatsSync = nativeBinding.diffWithStatsSync
...
module.exports.patchWithStats = nativeBinding.patchWithStats
module.exports.patchWithStatsSync = nativeBinding.patchWithStatsSync
